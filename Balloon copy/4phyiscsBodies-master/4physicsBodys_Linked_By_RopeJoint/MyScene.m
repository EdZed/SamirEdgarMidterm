...
-(void)didBeginContact:(SKPhysicsContact *)contact
{
    ...
    if(collision == (CNPhysicsCategoryBalloon|CNPhysicsCategoryAvoid))
    {
        ...
        _mySquare2.color = [SKColor greenColor];
        _mySquare3.color = [SKColor greenColor];
        _mySquare4.color = [SKColor greenColor];
        _mySquare5.color = [SKColor greenColor];
        _mySquare6.color = [SKColor greenColor];
        _mySquare7.color = [SKColor greenColor];
        _mySquare8.color = [SKColor greenColor];
    } else{
